...
generated_imgs_dir = 'data/trainGenerator'

# 清空增强图片文件夹
shutil.rmtree(generated_imgs_dir)
os.mkdir(generated_imgs_dir)

myGene = trainGenerator(2,'data/train','imgs','masks',data_gen_args,save_to_dir = generated_imgs_dir) # save_to_dir = 'data/trainGenerator'
